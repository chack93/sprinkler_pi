defmodule SprinklerPiUiWeb.AboutLive do
  ...
  def render(assigns) do
    ...
    <br/>
    <img phx-click="boom" src="<%= Routes.static_path(SprinklerPiUiWeb.Endpoint, "/images/phoenix.png") %>" width="<%= @width %>" style="background: <%= @bg %>;" />
    </div>
    """
  end
